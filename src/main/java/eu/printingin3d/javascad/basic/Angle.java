...
/**
 * Immutable representation of an angle. Has convenient methods to handle the
 * angles.
 */
public final class Angle extends BasicFunc<Angle> {
    ...
    /**
     * Creates an angle object which corresponds the given coordinates. The
     * order of the parameters are the same as the Math.atan2 method.
     * 
     * @param y
     *            the y coordinate
     * @param x
