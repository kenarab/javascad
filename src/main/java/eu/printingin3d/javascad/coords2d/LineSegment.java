...
public class LineSegment<T> {
    ...
    /**
     * Starts a series of line segments. You can get the next segment by calling
     * the next method. You can use the {@link #lineSegmentSeries(List)} method
     * to convert a list of coordinates to a list of line segments.
     * 
     * @param p
     *            the starting point
     * @param <T>
    ...
    /**
     * Returns with the list of line segments which is denoted by this series of
     * points.
     * 
     * @param coords
     *            the list of points
    ...
    public static <T> List<LineSegment<T>> lineSegmentSeries(List<T> coords) {
        ...
        LineSegment<T> current = new LineSegment<T>(null, coords.get(coords
                .size() - 1));
        for (T c : coords) {
     ...
     * 
     * @param c
     *            the next point of the point series
    ...
    /**
     * Checks if the given coordinate is equals with either end point of this
     * segment.
     * 
     * @param c
     *            the point to be checked
     * @return true if and only if either of the two end points of this segment
     *         is equals with the given point
     */
     ...
     * 
     * @param ls
     *            the other segment to be checked
     * @return true if and only if this segment and the given segment has a
     *         common end point
     */
    ...
    public boolean equals(Object obj) {
        ...
        return extendedEquals(start, other.start)
                && extendedEquals(end, other.end)
                || extendedEquals(end, other.start)
                && extendedEquals(start, other.end);
    }
