...
/**
 * Represents two intervals interpreting as an including square which could
 * contain the actual 2D object or objects.
 *
...
public class Boundaries2d {
    ...
    public static Boundaries2d combine(Collection<Boundaries2d> boundaries) {
        ...
        return new Boundaries2d(Boundary.combine(collectX),
