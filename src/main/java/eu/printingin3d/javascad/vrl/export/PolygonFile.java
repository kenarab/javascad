...
/**
 * An IFileExporter implementation for the Polygon file format. The usual
 * extension of the file is .ply. The exported file contains the color
 * information of the objects too.
 * 
