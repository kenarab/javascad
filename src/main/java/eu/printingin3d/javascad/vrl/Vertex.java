...
/**
 * Represents a vertex in the rendered CSG object, which consists of a
...
public class Vertex {
     ...
     * @param color
     *            the color of the vertex - can be null
     ...
     * 
     * @param bb
     *            byte buffer the representation of this vertex will be written
     *            to
     */
    ...
    /**
     * Formats this vertex with the given output format. Only STL and POLYGON
     * are supported yet.
     * 
     * @param outputFormat
    ...
    public String format(OutputFormat outputFormat) {
        ...
        case POLYGON:
            return coords.format(outputFormat) + color.getRed() + " "
                    + color.getGreen() + " " + color.getBlue();
        default:
            throw new IllegalValueException("Unsupported format: "
                    + outputFormat);
        }
    }
