...
/**
 * <p>
 * Immutable representation of one triangle in the mesh with a normal pointing
 * outward from the object.
 * </p>
 * <p>
 * It is used internally by the STL output generation, you don't really have to
 * use it directly.
 * </p>
 * 
...
public class Facet {
    ...
    /**
     * Returns all the vertices this facet holds. The result will always contain
