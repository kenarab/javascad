...
/**
 * <p>
 * Context generation factory to create a factory for the given includes and
 * excludes.
 * <p>
 * <p>
...
public class ScadGenerationContextFactory {
    /**
     * The default generation context. It includes everything - no filtering or
     * exclusion.
     */
     ...
     * 
     * @return a SCAD generation context that represents the includes and
     *         excludes set before
     */
