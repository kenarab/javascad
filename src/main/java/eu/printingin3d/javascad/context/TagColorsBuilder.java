...
/**
 * <p>
 * Builder of the {@link TagColors} to help to build the mapping easily.
 * </p>
 * <p>
 * The usual way to use this class is chaining:
 * </p>
 * 
 * <pre>
 * <code>new TagColorsBuilder()
...
public class TagColorsBuilder {
    ...
    /**
     * Adds a tag-color mapping to the builder which will be transferred to the
     * TagColors later.
     * 
     * @param tag
     *            the tag you want to assign a color to
     * @param color
     *            the color you want to assign
     ...
     * 
     * @return the TagColors object representing the mappings created in this
     *         object.
     */
