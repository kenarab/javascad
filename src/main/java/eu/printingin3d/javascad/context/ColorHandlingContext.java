...
/**
 * The default implementation of the {@link IColorGenerationContext} interface.
 * Gives an implementation based on tag-color pairs provided by the
 * {@link ITagColors}.
 * 
...
public class ColorHandlingContext implements IColorGenerationContext {
     ...
     */
    public static final IColorGenerationContext DEFAULT = new ColorHandlingContext(
            null, null, 0);
    ...
    /**
     * Creates a context with the given tag-color pairs. The most convenient way
     * to create such an object is using the {@link TagColorsBuilder} class.
     * 
     * @param tagColors
    ...
    protected ColorHandlingContext(ITagColors tagColors,
            IColorGenerationContext parent, int tag) {
