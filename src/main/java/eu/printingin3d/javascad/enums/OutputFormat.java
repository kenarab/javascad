...
public enum OutputFormat {
    /**
     * The SCAD output format. The format of a coordinate in SCAD is
     * <code>[10,20,30]</code>.
     */
    SCAD("[", "]", ","),
    /**
     * The textual STL output format. The format of a coordinate in an STL file
     * is <code>10 20 30</code>
     */
    STL("", "", " "),
    /**
     * The textual Polygon output format. The format of a coordinate in Polygon
     * file is <code>10 20 30</code>
     */
    POLYGON("", "", " ");
