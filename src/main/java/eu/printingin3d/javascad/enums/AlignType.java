...
public enum AlignType {
     ...
     * </p>
     * <p>
     * This behaves exactly the same as {@link #MIN_OUT} for backward
    ...
    MIN(1.0, 0.0, 0.0, 1.0),
    /**
     * Aligns to the higher parts on the axis, means the right, back and top. If
     * we align to another object we align to be inside of it.
     */
    MAX_IN(0.0, 1.0, 0.0, 1.0),
    /**
     * Aligns to the higher parts on the axis, means the right, back and top. If
     * we align to another object we align to be outside of it.
     */
     ...
     * </p>
     * <p>
     * This behaves exactly the same as {@link #MAX_OUT} for backward
     * compatibility reasons.
     * </p>
     * 
    ...
    private static final Map<AlignType, AlignType> INSIDE_MAP = new EnumMap<>(
            AlignType.class);
    private static final Map<AlignType, AlignType> OUTSIDE_MAP = new EnumMap<>(
            AlignType.class);
    static {
    ...
    AlignType(double relateMin, double relateMax, double modelMin,
            double modelMax) {
    ...
    /**
     * Return with the corresponding inside or outside alignment of this
     * alignment type based on the given parameter.
     * 
     * @param inside
     *            determine if we want to get the inside or outside version of
     *            this aligment
     * @return the corresponding outside alignment of this alignment type
     */
     ...
     * 
     * @param boundary
     *            the boundary we want to get
     * @return the minimum, maximum or middle value of the given boundary - or
     *         zero if the alignment is NONE
     */
    ...
    /**
     * Used internally to calculate the coordinate on the given axis. The result
     * is the necessary movement on that axis to reach the wanted alignment.
     * 
     * @param model
     ...
     *            the model we want to move
     * @param relateTo
     *            the coordinate we want to use as a reference in the alignment
     *            process
     * @return the necessary movement on that axis to reach the wanted alignment
     */
