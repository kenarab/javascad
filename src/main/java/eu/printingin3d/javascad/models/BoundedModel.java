...
/**
 * <p>
 * There are cases, when we want to have an object, which boundaries differ from
 * the calculated ones. An example could be a wardrobe, when we don't want to
 * include the handles into the boundary calculation, when we align the object.
 * </p>
 * <p>
...
public class BoundedModel extends Complex3dModel {
     ...
     * 
     * @param baseModel
     *            the object used to generate the output
     * @param boundaries3d
     *            the boundary used by the alignment methods
    ...
    public BoundedModel(Abstract3dModel baseModel, Boundaries3d boundaries3d) {
        AssertValue.isNotNull(baseModel,
                "The baseModel parameter must not be null!");
        AssertValue.isNotNull(boundaries3d,
                "The boundaries3d parameter must not be null!");
    ...
    protected Abstract3dModel innerSubModel(IScadGenerationContext context) {
        ...
        return subModel == null ? null : new BoundedModel(subModel,
                boundaries3d);
    }
