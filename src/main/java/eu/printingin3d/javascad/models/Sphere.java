...
/**
 * Represents a sphere. It is a descendant of {@link Abstract3dModel}, which
 * means you can use the convenient methods on spheres too.
 *
...
public class Sphere extends Atomic3dModel {
    ...
    /**
     * 
     * Creates the sphere with the given radius and resolution. TODO implement
     * in CSG
     * 
     * @param r
     * @param resolution
    ...
    private List<Coords3d> getVertices(Angle oneSlice, int numStacks, int i,
            int j) {
    ...
    private Coords3d sphereVertex(Angle theta, Angle phi) {
        Coords3d dir = new Coords3d(theta.cos() * phi.sin(), phi.cos(),
                theta.sin() * phi.sin());
