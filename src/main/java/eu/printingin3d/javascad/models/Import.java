...
/**
 * <p>
 * Represents an import operation in OpenSCAD. Although OpenSCAD supports
 * several formats in the import operation, in JavaSCAD only binary STL files
 * are supported as of now.
 * </p>
 * <p>
 * The file will be read and the boundaries of the object are determined based
 * on the content of the file, so aligning to this object will work exactly the
 * same way as any other object in JavaSCAD.
 * </p>
 */
public class Import extends Polyhedron {
    ...
    /**
     * Instantiate this import object with the given file. The file will be read
     * to determine the boundaries of the object.
     * 
     * @param file
     *            the file to be read
     * @throws IOException
     *             if there is any I/O error reading the file
     */
    ...
    private static List<Triangle3d> parseBytes(byte[] bFile) {
        ByteBuffer buffer = ByteBuffer.wrap(bFile).order(
