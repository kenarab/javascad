...
/**
 * Intersection operation. The result of this operation is the common part of
 * the child models. If there is no common part the getBoundaries method call
 * and all operations depending on that (eg. align) will throw an exception.
 *
...
public class Intersection extends Complex3dModel {
     ...
     * 
     * @param models
     *            the models used to create the intersection
     */
    ...
    protected Boundaries3d getModelBoundaries() {
        ...
        return boundaries.isEmpty() ? Boundaries3d.EMPTY : Boundaries3d
