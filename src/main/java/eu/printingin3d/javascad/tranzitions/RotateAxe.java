...
public class RotateAxe extends Complex3dModel {
	 ...
	 * @param angle the angle used by the rotation operation
	 * @param vector the axis of rotation used by the rotation operation
	 * 
	 * @throws IllegalValueException if either of the two parameters is null
	 */
	public RotateAxe(Abstract3dModel model, double angle,Coords3d vector) throws IllegalValueException {
		AssertValue.isNotNull(model, "The model should not be null for a rotation!");
		AssertValue.isNotNull(angle, "The angle should not be null for a rotation!");
		AssertValue.isNotNull(vector, "The vector should not be null for a rotation!");
	 ...
	 * @param angle the angle used by the rotate operation
	 * @param vector the angle used by the rotate operation
