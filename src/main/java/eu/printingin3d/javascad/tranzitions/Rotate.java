...
public class Rotate extends Complex3dModel {
     ...
     * @param angles
     *            the angles used by the rotation operation
     * @throws IllegalValueException
     *             if either of the two parameters is null
     */
    public Rotate(Abstract3dModel model, Angles3d angles)
            throws IllegalValueException {
        AssertValue.isNotNull(model,
                "The model should not be null for a rotation!");
        AssertValue.isNotNull(angles,
                "The angles should not be null for a rotation!");
     ...
     * 
     * @param angles
     *            the angles used by the rotate operation
    ...
    protected CSG toInnerCSG(FacetGenerationContext context) {
        return model.toCSG(context).transformed(
                TransformationFactory.getRotationMatrix(angles));
    }
