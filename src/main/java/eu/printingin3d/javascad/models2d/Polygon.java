...
public class Polygon extends Abstract2dModel {
    ...
    protected Polygon(Coords2d move, List<Coords2d> coords) {
        ...
        AssertValue.isTrue(coords.size() >= 3,
                "The list of coordinates should contain at least 3 elements!");
        this.coords = new ArrayList<>(coords);
    }

    /**
     * <p>
     * Creates a polygon. The polygon consists of the given coordinates. The
     * polygon is always closed, so it has an edge between the last and first
     * coordinates.
     * </p>
     * <p>
     * The given list should contain at least 3 coordinates, otherwise an
     * {@link eu.printingin3d.javascad.exceptions.IllegalValueException
     ...
     *             in case the given list contains fewer than 3 elements
     */
