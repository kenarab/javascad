 ...
 * move or rotate the 2D models. Every primitive 2D object and 2D transition
 * extend this class.
 * </p>
 *
...
public abstract class Abstract2dModel {
     ...
     * @return a new object which has been moved by the given coordinates - the
     *         original object left unmodified
     */
    public abstract Abstract2dModel move(Coords2d delta);

    protected abstract Collection<Area2d> getInnerPointCircle(
     ...
     * 
     * @param context
     *            the context to be used for the generation
     * @return the list of point to form this shape
     */
    public final Collection<Area2d> getPointCircle(
            FacetGenerationContext context) {
