...
public class Dims3d extends Basic3dFunc<Dims3d> {
    ...
    public Dims3d(double x, double y, double z) throws IllegalValueException {
        super(x, y, z);
        AssertValue.isNotNegative(x,
                "All dimensions should be positive, but x is " + x);
        AssertValue.isNotNegative(y,
                "All dimensions should be positive, but y is " + y);
        AssertValue.isNotNegative(z,
                "All dimensions should be positive, but z is " + z);
    }
