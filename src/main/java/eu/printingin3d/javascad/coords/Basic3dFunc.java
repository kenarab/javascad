...
public abstract class Basic3dFunc<T extends Basic3dFunc<T>> extends Abstract3d {
    ...
    /**
     * Add another value to this class and creates a new object of the same
     * class based on that.
     * 
     * @param value
    ...
    /**
     * Replaces the X coordinate with the given value and returns with the newly
     * created object.
     * 
     * @param x
     *            the new X value
    ...
    /**
     * Replaces the Y coordinate with the given value and returns with the newly
     * created object.
     * 
     * @param y
     *            the new Y value
    ...
    /**
     * Replaces the Z coordinate with the given value and returns with the newly
     * created object.
     * 
     * @param z
     *            the new Z value
    ...
    /**
     * Creates a collection of values which contains all variances of this
     * coordinates and their negated pair. The result contains at least one
     * element (for ZERO) and up to eight elements.
     * 
     * @return a collection of coordinates which contains all variances
     */
    public Collection<T> createVariances() {
        return new HashSet<T>(Arrays.asList(create(+x, +y, +z),
                create(-x, +y, +z), create(+x, -y, +z), create(-x, -y, +z),
                create(+x, +y, -z), create(-x, +y, -z), create(+x, -y, -z),
                create(-x, -y, -z)));
    }
}
