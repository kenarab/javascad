...
/**
 * This object calculates the boundary of a series of values. It represents an
 * interval which includes all of the values and all methods will use this
 * interval for any later calculation.
 *
...
public class Boundary {
     ...
     * 
     * @param boundaries
     *            the collections which should be considered
     ...
     */
    public static Boundary intersect(Collection<Boundary> boundaries)
            throws IllegalValueException {
        AssertValue.isNotEmpty(boundaries,
        ...
        for (Boundary b : boundaries) {
            ...
            AssertValue.isTrue(minValue <= b.getMax(),
                    "The boundaries should intersect with each other, "
                            + "but there is a gap between " + minValue
                            + " and " + b.getMax());
            AssertValue.isTrue(maxValue >= b.getMin(),
                    "The boundaries should intersect with each other, "
                            + "but there is a gap between " + maxValue
                            + " and " + b.getMin());
        }
    ...
    /**
     * Creates a Boundary object which has the given maximum value and the
     * middle is zero.
     * 
     * @param value
     *            the maximum value of the Boundary
    ...
    /**
     * Constructs an object using given values to calculate the minimum and
     * maximum values.
     * 
     * @param values
     *            the values used by the calculation
     */
    ...
    /**
     * <p>
     * Negate the current object if the parameter is true, but this object will
     ...
     * @return this object negated if the parameter true, the object unchanged
     *         otherwise
     */
    ...
    /**
     * Adding the given value to the interval and creates a new Boundary object
     * with the new values.
     * 
     * @param delta
     *            the value to move this interval
     ...
     * 
     * @param delta
     *            the value to add to this interval
     * @return a new object representing the new calculated interval
     */
    ...
    /**
     * Removes the values of the given boundary from this boundary and returns
     * with the remaining values.
     * 
     * @param b
     *            the boundary to be removed
    ...
    public Boundary remove(Boundary b) throws IllegalValueException {
        ...
        throw new IllegalValueException(
                "The given boundary contains this boundary!");
    }

    /**
     * Multiplying the interval with the given value, basically scaling it. The
     * method will create a new object and the current object will be unchanged.
     * 
     * @param delta
     *            the value used by the multiplication
     * @return a new object representing the new calculated interval
     */
    ...
    /**
     * Returns true if and only if this boundary is inside of the given
     * boundary. It means it gives true if the given boundary's minimum value is
     * not greater then this boundary's minimum value and the given boundary's
     * maximum value is not less then this boundary's maximum value.
     * 
     * @param b
     *            the given boundary
    ...
    /**
     * Returns true if and only if the given value is within this boundaries
     * limits.
     * 
     * @param value
     *            the given value
