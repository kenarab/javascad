 ...
 * </p>
 * <p>
 * Use the {@link ModelPart} annotation to denote the methods to be used as
 * parts for the export when extending this class. The
 * {@link IModelProvider#getAssembledModel} method should be still implemented
 * though.
 * </p>
 * 
...
public abstract class AnnotatedModelProvider implements IModelProvider {
    ...
    public final List<ModelWithPath> getModelsAndPaths() {
        ...
        for (Method m : getClass().getDeclaredMethods()) {
            ...
            if (a != null) {
                AssertValue.isTrue(
                        IModel.class.isAssignableFrom(m.getReturnType()),
                ...
                try {
                    ...
                    throw new IllegalValueException(
                            "Unknown exception has been thrown", e);
                }
            }
        }
