...
public class RoundProperties {
     ...
     * 
     * @param plane
     *            the plane used by the rounding
     * @param radius
    ...
    /**
     * Generates the OpenSCAD representation of the cylinder used by the
     * rounding operation with the necessary rotation if needed.
     * 
    ...
    public String getRounding() {
        ...
        return rotation + "cylinder(r=" + DoubleUtils.formatDouble(radius)
                + ", h=0.00001, center=true);";
    }

    /**
     * Calculates the size increase of the rounding operation. This is always
     * equals to the radius on those planes where the rounding takes effect.
     * 
