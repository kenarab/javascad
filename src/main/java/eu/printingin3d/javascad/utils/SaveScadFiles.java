 ...
 * 
 * <pre>
 * new SaveScadFiles(new File(&quot;c:/temp&quot;)).addModel(&quot;test.scad&quot;, new TestModel())
 *         .saveScadFiles();
 * </pre>
 * 
 * </blockquote>
...
public class SaveScadFiles {
     ...
     *             if the root is null or exists as a file
     */
    public SaveScadFiles(File root) throws IllegalValueException {
        ...
        AssertValue.isFalse(root.isFile(),
                "The root must not be an existing file - "
     ...
     *            the models to be saved
     * @param context
     *            the context used for the scad file generation
     * @return return this object to make it possible to chain more method call
     */
    public SaveScadFiles addModels(final String fileName,
            final Collection<IModel> models,
    ...
    /**
     * Adds a SCAD file with the given file name and the given model using the
     * default generation context. A default {@link Consts} is added before the
     * model.
     * 
     * @param fileName
     *            the name of the file where the model will be saved
    ...
    /**
     * Adds a SCAD file with the given file name and the given model. A default
     * {@link Consts} is added before the model.
     * 
     * @param fileName
     *            the name of the file where the model will be saved
     * @param model
     *            the model to be saved
     * @param tagColors
     *            the colors used for the scad file generation
     * @return return this object to make it possible to chain more method call
     */
    public SaveScadFiles addModel(String fileName, IModel model,
     ...
     *            the model to be saved
     * @param context
     *            the color context used for the scad file generation
     * @return return this object to make it possible to chain more method call
     */
    public SaveScadFiles addModel(String fileName, IModel model,
     ...
     * <code>addModel(fileName, model.subModel(context))</code> instead.
     * </p>
     * 
     * @param fileName
     *            the name of the file where the model will be saved
    ...
    /**
     * Adds a model provider with the default generation context. A default
     * {@link Consts} is added before the model.
     * 
     * @param provider
    ...
    /**
     * Adds a model provider with the given tag colors. A default {@link Consts}
     * is added before the model.
     * 
     * @param provider
     *            the provider to be added
     * @param tagColors
     *            the tag-color pairs to be used for the SCAD file generation
     * @return return this object to make it possible to chain more method call
     */
    public SaveScadFiles addModelProvider(IModelProvider provider,
            ITagColors tagColors) {
    ...
    /**
     * Adds a model provider with the given color context. A default
     * {@link Consts} is added before the model.
     * 
     * @param provider
     *            the provider to be added
     ...
     * 
     * @throws IOException
     *             if any IO error happens during the file write
     */
