...
/**
 * Represents a OpenSCAD source file. It can be implemented directly or used
 * through {@link SaveScadFiles}.
 *
...
public interface IScadFile {
     ...
     * 
     * @param root
     *            the root directory - the returned file must be under this
     *            directory.
