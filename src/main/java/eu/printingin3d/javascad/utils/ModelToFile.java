...
/**
 * This class can be used to write models to file. It can be used directly, but
 * it is advised to use it through the SaveScadFiles class.
 *
...
public class ModelToFile {
     ...
     * 
     * @param file
     *            the file where the model(s) will be saved
     ...
     * @throws IOException
     *             if any IO error happens during opening, writing or closing
     *             the file
     */
